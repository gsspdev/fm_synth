...
const WebFMSynthFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webfmsynth_free(ptr >>> 0, 1));

export class WebFMSynth {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebFMSynthFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webfmsynth_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.webfmsynth_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WebFMSynthFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    list_presets() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webfmsynth_list_presets(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    list_melodies() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webfmsynth_list_melodies(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    /**
     * @param {number} preset_idx
     * @param {number} melody_idx
     * @returns {Promise<void>}
     */
    play_melody(preset_idx, melody_idx) {
        const ret = wasm.webfmsynth_play_melody(this.__wbg_ptr, preset_idx, melody_idx);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_connect_c35b00704f73781f = function() { return handleError(function (arg0, arg1) {
        arg0.connect(arg1);
    }, arguments) };
    ...
    imports.wbg.__wbg_exponentialRampToValueAtTime_73e89a8aecb92e41 = function() { return handleError(function (arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('fm_synth_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
